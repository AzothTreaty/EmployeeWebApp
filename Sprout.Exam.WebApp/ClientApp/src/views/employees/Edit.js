...
<button type="button" onClick={() => this.props.history.push("/employees/index")} className="btn btn-primary">Back</button>
  ...
  async getEmployee(id) {
    ...
    this.setState({ id: data.id,fullName: data.fullName,birthdate: data.birthdate, salaryAmount: 2000,tin: data.tin,typeId: data.typeId, loading: false,loadingSave: false });
  }
}
